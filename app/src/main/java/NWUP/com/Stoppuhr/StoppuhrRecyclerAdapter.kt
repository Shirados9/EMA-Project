...
import kotlinx.android.synthetic.main.stoppuhr_recycler_exampleitem.view.*
...
class StoppuhrRecyclerAdapter(private val exampleList: List<StoppuhrExampleItem>) : RecyclerView.Adapter<StoppuhrRecyclerAdapter.ExampleViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExampleViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.stoppuhr_recycler_exampleitem,
                parent, false)
